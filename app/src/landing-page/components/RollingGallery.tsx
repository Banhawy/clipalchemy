...
const RollingGallery: React.FC<RollingGalleryProps> = ({
  ...
  return (
    <div className="relative w-full overflow-hidden">
      ...
      /> */}
    <SectionTitle title='Video Analysis' description='Transform your videos with AI-powered insights.' />
      <div className="flex items-center justify-center [perspective:1000px] [transform-style:preserve-3d]">
        ...
        >
          {galleryImages.map((url, i) => (
            <div
              key={i}
              className="group absolute flex h-fit items-center justify-center px-[8%] [backface-visibility:hidden] md:px-[6%]"
              style={{
                width: `${faceWidth}px`,
