...
const FeaturesGrid = ({ features, className = '' }: FeaturesGridProps) => {
  return (
    <div className='flex flex-col gap-4 my-16 md:my-24 lg:my-40 max-w-7xl mx-auto' id='features'>
      <SectionTitle title='Powerful Features' description='Transform any social media video into actionable, structured content with AI-powered analysis.' />
      <div
        className={cn(
...
function FeaturesGridItem({
  ...
  const gridFeatureCard = (
    <Card
      className={cn(
        'h-full min-h-[140px] transition-all duration-300 hover:shadow-lg',
