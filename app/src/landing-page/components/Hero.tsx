        ...
        <div className='mx-auto max-w-8xl px-6 lg:px-8'>
          <div className='lg:mb-18 mx-auto max-w-3xl text-center'>
            <h1 className='text-5xl font-bold text-foreground sm:text-6xl'>
              Transform <span className='italic'>any</span> social media video into{' '}
              <span className='text-gradient-primary'>actionable content</span>
            </h1>
            <p className='mt-6 mx-auto max-w-2xl text-lg leading-8 text-muted-foreground'>
              Extract recipes, beauty tutorials, and DIY guides from Instagram, TikTok, YouTube, and Facebook videos with AI-powered analysis. Get structured, ready-to-use content in seconds.
            </p>
            <div className='mt-10 flex items-center justify-center gap-x-6'>
              {/* <Button size='lg' variant='outline' asChild>
                <WaspRouterLink to={routes.PricingPageRoute.to}>View Demo</WaspRouterLink>
              </Button> */}
